				...
				<div class="row">
					...
					<div class="col-sm-6">
						...
						<div>
							...
							<textarea rows="4" style="resize: none;" class="form-control" ng-model="dados_orcamento.detalhes"></textarea>
						</div>
						<div style="padding-top:10px;">
							<button style="float: right;" type="button" class="btn btn-success waves-effect" ng-click="solicitarOrcamento()" data-dismiss="modal">Solicitar</button>
						</div>
					</div>
				</div>
			</div>
