<style type="text/css">
	...
	.card {
            ...
            max-width: 300px; /* Definindo o tamanho máximo dos cards */
            margin: 0 auto; /* Centralizando os cards */
            height: 400px; /* Definindo uma altura fixa para os cards */
            display: flex;
        ...
        .card img {
            ...
            object-fit: cover; /* Garantindo que as imagens mantenham a proporção */
            border-radius: 8px 8px 8px 8px;
            align-self: center; /* Centralizando a imagem verticalmente */
            object-position: center top; /* Ajustando a posição da imagem para começar do centro para cima */
        }
        .swiper-container {
            width: 100%; /* Ajustando a largura do container */
			overflow: hidden;
        }
