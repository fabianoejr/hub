...
$(document).ready(function() {
	...
	$("a.gabox").gabox({
		img_carregando: "https://www1.satc.edu.br/portais/colaborador_novo/assets/img/loading_animation.gif",
		img_fechar: "https://www1.satc.edu.br/portais/colaborador_novo/assets/img/remover.png",
	});
			...
			if(!$(this).hasClass("dataTable-custom")) {
				var opt = {
					...
					"oLanguage":{
						...
						"sInfo": "Mostrando <span>_START_</span> &agrave; <span>_END_</span> de <span>_TOTAL_</span> registros",
						"sLengthMenu": "Total encontrado: _MENU_ <span>registros</span>"
					}
				};
